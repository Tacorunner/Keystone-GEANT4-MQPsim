...
//
//
/// \file mQPSimPrimaryGeneratorAction.cc
/// \brief Implementation of the mQPSimPrimaryGeneratorAction class
  ...
  //fEnvelopeBox(0)
{
  ...
  fParticleGun->SetParticleEnergy(0.003*GeV);
}
...
void mQPSimPrimaryGeneratorAction::GeneratePrimaries(G4Event* anEvent)
{
