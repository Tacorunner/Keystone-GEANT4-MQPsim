...
void mQPSimDetectorConstruction::ConstructSDandField()
{
  ...
  auto PMTDetector = new G4MultiFunctionalDetector("PMTMFD");
  G4SDManager::GetSDMpointer()->AddNewDetector(PMTDetector);

  G4VPrimitiveScorer* primitive2;
  primitive2 = new G4PSNofSecondary("nGamma");
  PMTDetector->RegisterPrimitive(primitive2);
  ...
  SetSensitiveDetector("PMTface",PMTDetector);
  //
  // // sensitive detectors
